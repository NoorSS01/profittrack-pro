...
const Vehicles = () => {
  ...
  const canAddVehicle = plan === 'trial' || vehicleCount < limits.maxVehicles;
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description: "Vehicle and all related data deleted successfully!",
      });
    ...
    <PullToRefresh onRefresh={handleRefresh} className="min-h-[calc(100vh-8rem)] lg:min-h-0">
      <div className="space-y-6 page-transition">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground">Vehicles</h1>
        ...
        <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This will permanently delete <span className="font-semibold text-foreground">{vehicleToDelete?.vehicle_name}</span> and all associated trip entries. This action cannot be undone.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
